...
DATASET_PATH = "dataset_test/weather_2024-12-15_to_2024-12-16.csv"
TARGETS = [
...
if __name__ == "__main__":
    ...
    df.to_csv("test_logs/case_3_result.csv", index=False)
    print("✅ Saved test_logs/case_3_result.csv")